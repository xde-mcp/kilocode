export const dict = {
  ...
  "settings.providers.betaNotice":
    "Durante la beta, solo se puede configurar Kilo Gateway en la extensión. La configuración completa de proveedores —incluyendo todos los proveedores de la versión anterior— se añadirá pronto y estará disponible antes de que esta extensión salga de la beta. Estamos comprometidos a mantener Kilo abierto, sin ataduras.",
