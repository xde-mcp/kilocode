...
export const dict = {
  ...
  "error.paidModel.description": "Logg inn eller opprett en konto for å få tilgang til over 500 modeller, bruk kreditter til kostpris, eller ta med din egen nøkkel.",
  "error.paidModel.action": "Logg inn",
  "error.promotionLimit.title": "Du må registrere deg for å fortsette",
  "error.promotionLimit.description": "Registrer deg gratis for å fortsette og utforske over 500 modeller. Tar 2 minutter, ingen kredittkort nødvendig. Eller kom tilbake senere.",
