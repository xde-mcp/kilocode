...
export const dict = {
  ...
  "session.cloud.import.legacy":
    "Ungültige Sitzungs-ID. Cloud-Sitzungs-IDs müssen mit 'ses_' beginnen. Hinweis: Sitzungen aus der vorherigen Erweiterung sind mit dieser Version nicht kompatibel.",
