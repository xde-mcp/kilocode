export const dict = {
  ...
  "session.cloud.import.legacy": "Wygląda na to, że jest to starszy identyfikator sesji, który nie jest już obsługiwany. Proszę użyć identyfikatora sesji z aktualnej wersji rozszerzenia.",
