export const dict = {
  ...
  "settings.providers.betaNotice":
    "خلال المرحلة التجريبية، يمكن تكوين Kilo Gateway فقط في الإضافة. ستتم إضافة الإعداد الكامل للمزودين — بما في ذلك جميع المزودين من الإصدار السابق — قريباً وسيكون متاحاً قبل خروج هذه الإضافة من المرحلة التجريبية. نحن ملتزمون بإبقاء Kilo مفتوحاً، دون تقييد.",
