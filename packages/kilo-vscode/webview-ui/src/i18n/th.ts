export const dict = {
  ...
  "settings.providers.betaNotice":
    "ในช่วงเบต้า จะสามารถกำหนดค่าได้เฉพาะ Kilo Gateway ในส่วนขยายเท่านั้น การกำหนดค่าผู้ให้บริการแบบเต็มรูปแบบ — รวมถึงผู้ให้บริการทั้งหมดจากเวอร์ชันก่อนหน้า — จะถูกเพิ่มเข้ามาในเร็วๆ นี้ และจะพร้อมใช้งานก่อนที่ส่วนขยายนี้จะออกจากช่วงเบต้า เรามุ่งมั่นที่จะรักษาให้ Kilo เปิดกว้าง ไม่มีการผูกมัด",
