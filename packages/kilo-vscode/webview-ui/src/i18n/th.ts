export const dict = {
  ...
  "settings.providers.betaNotice":
    "ในช่วงเบต้า จะสามารถตั้งค่าได้เฉพาะ Kilo Gateway ในส่วนขยายเท่านั้น การรองรับผู้ให้บริการทั้งหมดอย่างเต็มรูปแบบ — รวมถึงจากเวอร์ชันก่อนหน้า — กำลังจะมาในเร็วๆ นี้ เรามุ่งมั่นที่จะรักษาให้ Kilo เปิดกว้าง โดยไม่มีการผูกมัด",
