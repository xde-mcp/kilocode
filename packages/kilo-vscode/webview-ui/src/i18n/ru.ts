export const dict = {
  ...
  "settings.providers.betaNotice":
    "Во время бета-тестирования в расширении можно настроить только Kilo Gateway. Полная поддержка всех провайдеров — включая тех, что были в предыдущей версии, — скоро появится. Мы стремимся сохранить Kilo открытым, без привязки к вендору.",
