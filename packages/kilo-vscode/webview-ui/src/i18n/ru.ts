export const dict = {
  ...
  "session.cloud.import.legacy": "Похоже, это устаревший идентификатор сессии, который больше не поддерживается. Пожалуйста, используйте идентификатор сессии из текущей версии расширения.",
