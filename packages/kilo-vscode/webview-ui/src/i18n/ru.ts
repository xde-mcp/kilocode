export const dict = {
  ...
  "settings.providers.betaNotice":
    "Во время бета-тестирования в расширении можно настроить только Kilo Gateway. Полная настройка провайдеров — включая всех провайдеров из предыдущей версии — будет добавлена в ближайшее время и станет доступна до выхода этого расширения из бета-версии. Мы стремимся сохранить Kilo открытым, без привязки к вендору.",
