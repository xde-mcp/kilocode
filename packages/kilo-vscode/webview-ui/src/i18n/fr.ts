export const dict = {
  ...
  "error.paidModel.description": "Connectez-vous ou créez un compte pour accéder à plus de 500 modèles, utiliser des crédits au prix coûtant ou apporter votre propre clé.",
  "error.paidModel.action": "Se connecter",
  "error.promotionLimit.title": "Vous devez vous inscrire pour continuer",
  "error.promotionLimit.description": "Inscrivez-vous gratuitement pour continuer et explorer plus de 500 modèles. 2 minutes, sans carte bancaire. Ou revenez plus tard.",
