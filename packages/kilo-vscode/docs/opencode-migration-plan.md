...
| [Code Actions & Editor Menus](non-agent-features/editor-context-menus-and-code-actions.md)              | Terminal content capture (shell integration API), custom prompt overrides via settings            | Extension-side (VS Code CodeActionProvider + menus + keybindings)    | P1       |
