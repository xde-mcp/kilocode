...
Cloud Agents support project-level [skills](../features/skills) stored in your repository. When your repo is cloned, any skills in `.kilocode/skills/` are automatically available.
