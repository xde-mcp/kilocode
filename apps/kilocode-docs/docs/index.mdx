...
4. [Enable Autocomplete](/features/autocomplete/overview) for inline code suggestions
...
Use [the chat interface](/basic-usage/the-chat-interface) to tell Kilo Code what you need, or let [Autocomplete](/features/autocomplete/overview) suggest code as you type. It relies on coding‑optimized AI models to complete each request.
...
- [Autocomplete](/features/autocomplete/overview) - Get AI-powered code suggestions as you type
