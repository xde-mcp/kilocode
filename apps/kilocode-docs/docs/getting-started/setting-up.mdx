...
When you sign up for Kilo Code, you can start immediately with free models, or [add credits to your account](../basic-usage/adding-credits) and get bonus credits.
