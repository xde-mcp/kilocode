...
- [Custom Modes](/docs/features/custom-modes) - Create custom modes that can use specific skills
- [Custom Instructions](/docs/advanced-usage/custom-instructions) - Global instructions vs. skill-based instructions
- [Custom Rules](/docs/advanced-usage/custom-rules) - Project-level rules complementing skills
