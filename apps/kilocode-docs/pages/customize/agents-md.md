...
The Kilo Code **memory bank** feature has been deprecated in favor of AGENTS.md. **Existing memory bank rules will continue to work just fine** — migration is optional, not required.
