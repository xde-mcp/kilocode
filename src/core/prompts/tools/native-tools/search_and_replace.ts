...
export function shouldUseSearchAndReplaceInsteadOfApplyDiff(modelId: string) {
...
export default {
	...
	function: {
		name: "apply_diff",
		description:
			"Replace a specific string in a file with a new string. This is used for making precise edits. Only the first match is replaced, be sure to include enough context.",
		strict: true,
